...
import type { ProjectApplication, Team } from '../auth/types'
...
export function MyWorkPage() {
  ...
  useEffect(() => {
    Promise.all([authenticatedRequest<ProjectApplication[]>('/api/applications'), authenticatedRequest<Team[]>('/api/teams')])
      .then(([loadedApplications, loadedTeams]) => { setApplications(loadedApplications); setTeams(loadedTeams) })
